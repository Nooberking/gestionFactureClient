        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Voici tous les clients présents dans la BDD.</li>
                </ol>
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-primary text-white mb-4">
                            <div class="card-body">Ajouter un Client</div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="Clients/Ajout"><i class="fa-solid fa-user-plus"></i></a>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <table id="datatablesSimple">
                            ...
                            <tr>
                                <td>${client.getCli_nom()}</td>
                                <td>${client.getCli_prenom()}</td>
                                <td>${client.getCli_adr()}</td>
