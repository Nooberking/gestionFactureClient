    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Liste des Factures</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Voici toutes les factures présentes dans la BDD.</li>
                </ol>
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-primary text-white mb-4">
                            <div class="card-body">Générer une facture</div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="Factures/Generer"><i class="fa-solid fa-user-plus"></i></a>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <table id="datatablesSimple">
                            ...
                            <c:forEach var="facture" items="${allFactures}">

                            <tr>
                                <td>${facture.getId()}</td>
                                <td>${facture.getId_cli()}</td>
                                <td>${facture.getTva()}</td>
                                <td><a href ="${facture.geLoc_pdf()}">Télecharger la facture</a></td>
                                <td>${facture.getDate_creation()}</td>
                            </tr>
                            </c:forEach>
